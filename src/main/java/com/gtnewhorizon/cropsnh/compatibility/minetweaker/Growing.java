...
public class Growing {
    ...
    public static class FertileSoils {
        ...
        public static void remove(IItemStack[] soils) {
            ...
            if (areValidSoils(soilsToRemove)) {
                ...
                MineTweakerAPI.logError(
                        "Error removing soils from the whitelist. All provided items must be of type ItemBlock.");
            }
        }
        ...
        private static class AddAction implements IUndoableAction {
            ...
            public AddAction(ItemStack[] soils) {
                ...
                for (ItemStack stack : soils) {
                    this.soils.add(
                            new BlockWithMeta(((ItemBlock) stack.getItem()).field_150939_a, stack.getItemDamage()));
                }
            }
    ...
    public static class BaseBlock {
        ...
        private static class SetAction implements IUndoableAction {
            ...
            @Override
            public String describeUndo() {
                String blockString = (oldReqBlock != null && oldReqBlock.getBlock() != null)
                        ? oldReqBlock.getBlock().getLocalizedName()
                        : "DEFAULT";
