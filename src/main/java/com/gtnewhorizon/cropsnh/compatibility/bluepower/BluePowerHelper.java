...
public final class BluePowerHelper extends ModHelper {
    ...
    protected void initPlants() {
        OreDictionary
                .registerOre(Names.OreDict.listAllseed, (Item) Item.itemRegistry.getObject("bluepower:flax_seeds"));
        ...
        try {
            CropPlantHandler.registerPlant(
                    new CropPlantBluePower((ItemSeeds) Item.itemRegistry.getObject("bluepower:flax_seeds")));
