        ...
        while (amount > 0) {
            ...
            if (spawnMandrake) {
                try {
                    ...
                    Entity mandrake = (Entity) Class.forName("com.emoniph.witchery.entity.EntityMandrake")
                    ...
                    Object explodeEffect = particleEffectClass.getField("EXPLODE")
                        .get(null);
                    // sound effect
                    Class<?> soundEffectClass = Class.forName("com.emoniph.witchery.util.SoundEffect");
                    Object noneEffect = soundEffectClass.getField("NONE")
                        .get(null);
                    // create packet
                    Object packetParticles = Class.forName("com.emoniph.witchery.network.PacketParticles")
                        .getConstructor(particleEffectClass, soundEffectClass, Entity.class, double.class, double.class)
                        .newInstance(explodeEffect, noneEffect, mandrake, 0.5D, 1.0D);
                    // target point
                    Object targetPoint = Class.forName("com.emoniph.witchery.util.TargetPointUtil")
                        .getDeclaredMethod("from", Entity.class, double.class)
                        .invoke(null, mandrake, 16.0D);
                    // send message
                    Method sendToAllAllAroundMethod = Class.forName("com.emoniph.witchery.network.PacketPipeline")
                        .getDeclaredMethod("sendToAllAround", IMessage.class, NetworkRegistry.TargetPoint.class);
                    Object packetPipeline = Class.forName("com.emoniph.witchery.Witchery")
                        .getDeclaredField("packetPipeline")
                        .get(null);
