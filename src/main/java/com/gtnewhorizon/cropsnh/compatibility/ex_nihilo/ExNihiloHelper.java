...
public final class ExNihiloHelper extends ModHelper {
    ...
    protected void onInit() {
        ...
        GameRegistry.addShapelessRecipe(
                ...
                new ItemStack(seedCarrot));
        GameRegistry.addShapelessRecipe(
                new ItemStack((Item) Item.itemRegistry.getObject("CropsNH:seedSugarcane")),
                new ItemStack(seedSugarCane));
        GameRegistry.addShapelessRecipe(
                new ItemStack((Item) Item.itemRegistry.getObject("CropsNH:seedCactus")),
                new ItemStack(seedCactus));
    }
