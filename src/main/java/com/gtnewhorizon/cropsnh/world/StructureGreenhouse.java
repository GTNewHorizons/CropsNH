...
public class StructureGreenhouse extends StructureVillagePieces.House1 {
    ...
    protected boolean generateStructureCrop(World world, StructureBoundingBox boundingBox, int x, int y, int z, boolean crosscrop, ArrayList<CropPlant> plants) {
        ...
        if (boundingBox.isVecInside(xCoord, yCoord, zCoord)) {
            world.setBlock(xCoord, yCoord, zCoord, com.gtnewhorizon.cropsnh.init.Blocks.blockCrop, 0, 2);
    ...
    protected boolean generateStructureSeedAnalyzer(World world, StructureBoundingBox boundingBox, int x, int y, int z, ForgeDirection direction) {
        ...
        int zCoord = this.getZWithOffset(x, z);
        if (boundingBox.isVecInside(xCoord, yCoord, zCoord)) {
            world.setBlock(xCoord, yCoord, zCoord, com.gtnewhorizon.cropsnh.init.Blocks.blockSeedAnalyzer, 0, 2);
