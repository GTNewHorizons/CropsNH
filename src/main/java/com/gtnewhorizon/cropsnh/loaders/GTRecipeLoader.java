...
public abstract class GTRecipeLoader extends BaseGTRecipeLoader {
    ...
    private static void AddCropStickRecipes() {
        ...
        ulvRecipe(2, 0)
            ...
            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.Wood, ConfigurationHandler.cropsPerCraft * 4L))
    ...
    private static final CropsNHItemList[] CROP_MANAGERS = new CropsNHItemList[] {
    ...
    private static final ItemList[] INPUT_HATCHES = new ItemList[] {
