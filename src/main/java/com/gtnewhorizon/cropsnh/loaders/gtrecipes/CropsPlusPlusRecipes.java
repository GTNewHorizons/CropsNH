...
public abstract class CropsPlusPlusRecipes extends BaseGTRecipeLoader {
    ...
    private static void addAlcoholRecipes() {
        ...
        GTValues.RA.stdBuilder().fluidInputs(new FluidStack(CropsNHFluids.Mash, 10))
            .fluidOutputs(new FluidStack(CropsNHFluids.Wash, 8)).duration(50 * SECONDS).eut(2).addTo(fermentingRecipes);

        GTValues.RA.stdBuilder().fluidInputs(new FluidStack(CropsNHFluids.Wash, 20))
        ...
        GTValues.RA.stdBuilder().fluidInputs(new FluidStack(FluidRegistry.getFluid("potion.wheatyjuice"), 10))
            .fluidOutputs(new FluidStack(CropsNHFluids.FWheat, 8)).duration(51 * SECONDS).eut(2)
            .addTo(fermentingRecipes);

        GTValues.RA.stdBuilder().fluidInputs(new FluidStack(FluidRegistry.getFluid("potion.reedwater"), 10))
                .fluidOutputs(new FluidStack(CropsNHFluids.FReed, 8)).duration(51 * SECONDS).eut(2)
                .addTo(fermentingRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(new FluidStack(CropsNHFluids.Korn, 100)).fluidOutputs(Materials.Ethanol.getFluid(25))
                .duration(16 * TICKS).eut(24).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(new FluidStack(CropsNHFluids.Korn, 100)).fluidOutputs(Materials.Water.getFluid(68))
                .duration(16 * TICKS).eut(24).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(new FluidStack(CropsNHFluids.DKorn, 100)).fluidOutputs(Materials.Ethanol.getFluid(30))
                .duration(16 * TICKS).eut(24).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(new FluidStack(CropsNHFluids.DKorn, 100)).fluidOutputs(Materials.Water.getFluid(62))
                .duration(16 * TICKS).eut(24).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(new FluidStack(CropsNHFluids.FWheat, 80)).fluidOutputs(new FluidStack(CropsNHFluids.Korn, 1))
                .duration(1 * SECONDS + 2 * TICKS).eut(24).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(new FluidStack(CropsNHFluids.FWheat, 95)).fluidOutputs(new FluidStack(CropsNHFluids.DKorn, 1))
        ...
        mvRecipe(2, 75).itemInputs(GTUtility.getIntegratedCircuit(5))
                .fluidInputs(new FluidStack(CropsNHFluids.FWheat, 250)).fluidOutputs(Materials.Ethanol.getFluid(1))
                .addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(new FluidStack(CropsNHFluids.FReed, 100)).fluidOutputs(new FluidStack(CropsNHFluids.SWhine, 7))
                .duration(1 * SECONDS + 2 * TICKS).eut(24).addTo(distilleryRecipes);
        ...
        mvRecipe(2, 20)
            ...
            .fluidInputs(new FluidStack(CropsNHFluids.FReed, 200)).fluidOutputs(Materials.Ethanol.getFluid(1))
            .addTo(distilleryRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(new FluidStack(CropsNHFluids.Wash, 100)).fluidOutputs(new FluidStack(CropsNHFluids.GHP, 6))
                .duration(1 * SECONDS + 2 * TICKS).eut(24).addTo(distilleryRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Empty.getCells(4)).fluidInputs(new FluidStack(CropsNHFluids.GHP, 375))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        new ItemStack(Items.dye, 1, 2),
                        Materials.Water.getCells(1))
                .itemOutputs(Materials.Empty.getCells(1)).fluidInputs(new FluidStack(CropsNHFluids.Korn, 1000))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        new ItemStack(Items.dye, 1, 2),
                        Materials.Water.getCells(1))
                .itemOutputs(Materials.Empty.getCells(1)).fluidInputs(new FluidStack(CropsNHFluids.DKorn, 750))
        ...
        if (Mods.PamsHarvestCraft.isModLoaded()) {
            GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(CropsNHFluids.njagi, 5000)).duration(10 * TICKS).eut(8).addTo(mixerRecipes);
        }
        ...
        luvRecipe(0,1)
                ...
                .fluidInputs(new FluidStack(CropsNHFluids.njagi, 50000)).fluidOutputs(new FluidStack(CropsNHFluids.jagi, 250))
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Water.getCells(1), new ItemStack(Items.sugar))
                .itemOutputs(Materials.Empty.getCells(1)).fluidInputs(new FluidStack(CropsNHFluids.SWhine, 5000))
        ...
        for (ItemStack itemStack : OreDictionary.getOres("listAllberry")) {
            GTValues.RA.stdBuilder().itemInputs(itemStack.splitStack(16)).fluidInputs(Materials.Water.getFluid(750))
                    .fluidOutputs(new FluidStack(CropsNHFluids.Mash, 750)).duration(6 * SECONDS + 8 * TICKS).eut(4)
    ...
    private static void addDyeConversionRecipe(ItemStack input, Fluid dyeFluid) {
        mvRecipe(12, 0)
            .itemInputs(input, Materials.Salt.getDust(2))
