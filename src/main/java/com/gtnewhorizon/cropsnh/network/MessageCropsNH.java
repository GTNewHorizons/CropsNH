...
public abstract class MessageCropsNH implements IMessage {
    ...
    protected void writePlayerToByteBuf(EntityPlayer player, ByteBuf buf) {
        String playerName = player == null ? "null"
    ...
    protected Entity readEntityFromByteBuf(ByteBuf buf) {
        return CropsNH.proxy.getEntityById(buf.readInt(), buf.readInt());
    }
