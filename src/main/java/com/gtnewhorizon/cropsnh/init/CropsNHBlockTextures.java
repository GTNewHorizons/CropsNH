...
public class CropsNHBlockTextures {
    ...
    public static final IIconContainer OVERLAY_FRONT_GENE_EXTRACTOR_ACTIVE = new CustomIcon("tileEntities/machines/gene_extractor/OVERLAY_GENE_EXTRACTOR_FRONT_ACTIVE");
    public static final IIconContainer OVERLAY_FRONT_GENE_EXTRACTOR_ACTIVE_GLOW = new CustomIcon("tileEntities/machines/gene_extractor/OVERLAY_GENE_EXTRACTOR_FRONT_ACTIVE_GLOW");
    public static final IIconContainer OVERLAY_FRONT_GENE_EXTRACTOR = new CustomIcon("tileEntities/machines/gene_extractor/OVERLAY_GENE_EXTRACTOR_FRONT");
    public static final IIconContainer OVERLAY_FRONT_GENE_EXTRACTOR_GLOW = new CustomIcon("tileEntities/machines/gene_extractor/OVERLAY_GENE_EXTRACTOR_FRONT_GLOW");
