...
public class Recipes {
            ...
            if (OreDictHelper.getNuggetForName("Diamond") instanceof ItemCropsNH) {
                GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                        ...
                        "nuggetDiamond"));
                GameRegistry.addRecipe(
                    new ShapelessOreRecipe(new ItemStack(OreDictHelper.getNuggetForName("Diamond"), 9), "gemDiamond"));
            }
            if (OreDictHelper.getNuggetForName("Emerald") instanceof ItemCropsNH) {
                GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                        ...
                        "nuggetEmerald"));
                GameRegistry.addRecipe(
                    new ShapelessOreRecipe(new ItemStack(OreDictHelper.getNuggetForName("Emerald"), 9), "gemEmerald"));
            }
    ...
    public static void registerCustomWoodRecipe(IRecipe recipe) {
        if (recipe instanceof ShapedRecipes) {
            ...
            registerCustomWoodRecipe(
                ((ItemBlock) shapedRecipe.getRecipeOutput()
            ...
            registerCustomWoodRecipe(
                ((ItemBlock) shapelessRecipe.getRecipeOutput()
                    .getItem()).field_150939_a,
