...
public class ResourceCrops {
    ...
    private static void initVanillaResources() {
        ...
        Object[][] vanillaResources = {
            ...
            { "Ferranium",
                new ItemStack(OreDictHelper.getNuggetForName("Iron"), 1, OreDictHelper.getNuggetMetaForName("Iron")),
            ...
            { "NitorWart", new ItemStack(net.minecraft.init.Items.glowstone_dust), new BlockWithMeta(Blocks.soul_sand),
                RequirementType.BELOW, new BlockWithMeta(Blocks.glowstone, 0), 4, RenderMethod.HASHTAG },
            { "Quartzanthemum", new ItemStack(OreDictHelper.getNuggetForName("Quartz")),
                new BlockWithMeta(Blocks.soul_sand), RequirementType.BELOW, new BlockWithMeta(Blocks.quartz_ore, 0), 4,
                RenderMethod.HASHTAG } };
