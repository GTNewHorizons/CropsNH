...
public class GrowthRequirementHandler {
     ...
     * soil will be able to grown on these This list can be modified with MineTweaker
     */
    public static List<BlockWithMeta> defaultSoils = new ArrayList<>();

    /**
     * This list contains soils needed for certain CropPlants This list cannot be modified externally
     */
