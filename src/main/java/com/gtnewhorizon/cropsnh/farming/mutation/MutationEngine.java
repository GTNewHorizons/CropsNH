...
/**
 * This class decides whether a plant is spreading or mutating and also calculates the new stats (growth, gain,
 * strength) of the new plant based on the 4 neighbours.
 */
public class MutationEngine implements IMutationEngine {
    ...
    public ICrossOverResult rollAndExecuteStrategy() {
        ...
        return spreading ? getMutationHandler().getMutationLogic().getSpreadingResult(this)
