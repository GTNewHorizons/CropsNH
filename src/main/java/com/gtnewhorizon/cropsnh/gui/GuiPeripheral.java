...
public class GuiPeripheral extends GuiContainer {
    ...
    private void drawMethodHelp(IMethod method) {
        if(method != null) {
            ...
            this.fontRendererObj.drawString(StatCollector.translateToLocal("cropsnh_description.peripheralHelp") + ": " + method.signature(), this.guiLeft + 7, this.guiTop + 175, WHITE);
            float scale = 0.9F;
            GL11.glScalef(scale, scale, scale);
