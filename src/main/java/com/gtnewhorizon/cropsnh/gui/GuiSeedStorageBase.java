...
public abstract class GuiSeedStorageBase extends GuiContainer {
    ...
    protected void loadButtons() {
        ...
        int buttonWidth = 60;
        int buttonHeight = 12;
        this.buttonList.add(new GuiButton(buttonIdGrowth, this.guiLeft + sortButtonX, this.guiTop + sortButtonY, buttonWidth, buttonHeight, StatCollector.translateToLocal("cropsnh_tooltip.growth")));
        this.buttonList.add(new GuiButton(buttonIdGain, this.guiLeft + sortButtonX, this.guiTop + sortButtonY+buttonHeight+1, buttonWidth, buttonHeight, StatCollector.translateToLocal("cropsnh_tooltip.gain")));
        this.buttonList.add(new GuiButton(buttonIdStrength, this.guiLeft + sortButtonX, this.guiTop + sortButtonY + 2 * (buttonHeight + 1), buttonWidth, buttonHeight, StatCollector.translateToLocal("cropsnh_tooltip.strength")));
