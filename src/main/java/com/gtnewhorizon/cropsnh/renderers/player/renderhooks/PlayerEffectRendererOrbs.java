...
public class PlayerEffectRendererOrbs extends PlayerEffectRenderer {
    ...
    protected PlayerEffectRendererOrbs() {
        ...
        R = 1;
        MAX_BLURS = 5;
        quas = new ResourceLocation("cropsnh", "textures/entities/player/invoker/quas.png");
        wex  = new ResourceLocation("cropsnh", "textures/entities/player/invoker/wex.png");
        exort = new ResourceLocation("cropsnh", "textures/entities/player/invoker/exort.png");
    }
