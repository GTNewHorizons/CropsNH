...
public class PlayerEffectRendererButterfly extends PlayerEffectRenderer {
    ...
    protected PlayerEffectRendererButterfly() {
        super();
        texture = new ResourceLocation("cropsnh", "textures/entities/player/butterfly/butterfly.png");
        sparkle = new ResourceLocation("cropsnh", "textures/entities/player/butterfly/sparkle.png");
    }
