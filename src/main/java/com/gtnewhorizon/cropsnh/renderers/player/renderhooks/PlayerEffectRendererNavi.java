...
public class PlayerEffectRendererNavi extends PlayerEffectRenderer {
    ...
    protected PlayerEffectRendererNavi() {
        ...
        largeWing = new ResourceLocation("cropsnh", "textures/entities/player/navi/wingLarge.png");
        smallWing = new ResourceLocation("cropsnh", "textures/entities/player/navi/wingSmall.png");
        texture = new ResourceLocation("cropsnh", "textures/entities/player/navi/navi.png");
