...
public abstract class RenderBlockBase extends TileEntitySpecialRenderer
    ...
    /**
     * Rotates a plane. This is impressively useful, but may not be impressively efficient. Always returns a 6-element
     * array. Defaults to the north direction (the base direction).
     * <p>
