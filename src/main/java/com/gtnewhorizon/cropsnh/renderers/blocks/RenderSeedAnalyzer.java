...
import com.gtnewhorizon.cropsnh.renderers.models.ModelSeedAnalyzer;
import com.gtnewhorizon.cropsnh.renderers.models.ModelSeedAnalyzerBook;
...
public class RenderSeedAnalyzer extends RenderBlockBase {
    ...
    public RenderSeedAnalyzer() {
        ...
        this.bookTexture = new ResourceLocation(
            Reference.MOD_ID.toLowerCase() + ":textures/blocks/seedAnalyzerBook.png");
