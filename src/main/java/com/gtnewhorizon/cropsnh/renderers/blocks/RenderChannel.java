...
import com.gtnewhorizon.cropsnh.tileentity.irrigation.IIrrigationComponent;
...
import com.gtnewhorizon.cropsnh.tileentity.irrigation.TileEntityValve;
...
public class RenderChannel extends RenderBlockCustomWood<TileEntityChannel> {
    ...
    public RenderChannel() {
        this(com.gtnewhorizon.cropsnh.init.Blocks.blockWaterChannel, new TileEntityChannel());
    }
