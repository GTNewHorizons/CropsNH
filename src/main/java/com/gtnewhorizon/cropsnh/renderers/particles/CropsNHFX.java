...
public abstract class CropsNHFX extends EntityFX {
    protected final ResourceLocation texture;

    protected CropsNHFX(World world, double x, double y, double z, float scale, float gravity, Vec3 vector, ResourceLocation texture) {
    ...
    protected CropsNHFX(World world, double x, double y, double z, float scale, float gravity, Vec3 vector, IIcon icon) {
        super(world, x, y, z, 0, 0, 0);
        this.texture = null;
