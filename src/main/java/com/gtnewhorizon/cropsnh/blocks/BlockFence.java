...
import com.gtnewhorizon.cropsnh.renderers.blocks.RenderBlockFence;
import com.gtnewhorizon.cropsnh.tileentity.decoration.TileEntityFence;
...
public class BlockFence extends BlockCustomWood {
    ...
    public boolean applyLead(EntityPlayer player, World world, int x, int y, int z) {
        EntityLeashKnotCropsNH leashKnot = EntityLeashKnotCropsNH.getKnotForBlock(world, x, y, z);
        boolean flag = false;
        double d0 = 7.0D;
        ...
        if (list != null) {
            for (Object obj : list) {
                ...
                if (entityliving.getLeashed() && entityliving.getLeashedToEntity() == player) {
                    if (leashKnot == null) {
                        leashKnot = EntityLeashKnotCropsNH.func_110129_a(world, x, y, z);
                    }
