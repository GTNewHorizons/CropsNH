...
import static com.gtnewhorizon.cropsnh.init.CropsNHBlockTextures.OVERLAY_FRONT_GENE_EXTRACTOR;
import static com.gtnewhorizon.cropsnh.init.CropsNHBlockTextures.OVERLAY_FRONT_GENE_EXTRACTOR_ACTIVE;
import static com.gtnewhorizon.cropsnh.init.CropsNHBlockTextures.OVERLAY_FRONT_GENE_EXTRACTOR_ACTIVE_GLOW;
import static com.gtnewhorizon.cropsnh.init.CropsNHBlockTextures.OVERLAY_FRONT_GENE_EXTRACTOR_GLOW;
        ...
        super(
            ...
            TextureFactory.of(
                ...
                TextureFactory.builder()
                    ...
                    .build()),
            TextureFactory.of(
                TextureFactory.of(OVERLAY_FRONT_GENE_EXTRACTOR_ACTIVE),
                TextureFactory.builder()
                    .addIcon(OVERLAY_FRONT_GENE_EXTRACTOR_ACTIVE_GLOW)
                    .glow()
                    .build()),
            TextureFactory.of(
                TextureFactory.of(OVERLAY_FRONT_GENE_EXTRACTOR),
                TextureFactory.builder()
                    .addIcon(OVERLAY_FRONT_GENE_EXTRACTOR_GLOW)
                    .glow()
                    .build()),
            TextureFactory.of(
