...
/**
 * This class represents the root tile entity for all CropsNH custom wood blocks. Through this class, the custom woods
 * are remembered for the blocks. *
 */
public class TileEntityCustomWood extends TileEntityCropsNH implements IDebuggable {
    ...
    /**
     * Sets the CustomWood block's material, the material to mimic, from an NBTTag. This function is intended for use
    ...
    public void addWailaInformation(List information) {
        ...
        information.add(
                StatCollector.translateToLocal("cropsnh_tooltip.material") + ": "
                        + mat.getItem().getItemStackDisplayName(mat));
    }
}
