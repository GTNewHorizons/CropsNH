...
public class TileEntitySeedStorage extends TileEntityCustomWood implements ISeedStorageControllable, IDebuggable, ISidedInventory {
    ...
    public void syncSlotToClient(SeedStorageSlot slot) {
        NetworkWrapperCropsNH.wrapper.sendToDimension(new MessageTileEntitySeedStorage(this.xCoord, this.yCoord, this.zCoord, slot), this.worldObj.provider.dimensionId);
    ...
    public void addWailaInformation(List information) {
        information.add(StatCollector.translateToLocal("cropsnh_tooltip.storage") + ": " + (this.hasLockedSeed() ? getLockedSeed().getDisplayName() : StatCollector.translateToLocal("cropsnh_tooltip.none")));
