...
public class MethodGetCurrentSoil extends MethodBaseCrop {
    ...
    protected Object[] onMethodCalled(TileEntityCrop crop) {
        Block block = crop.getWorldObj()
            .getBlock(crop.xCoord, crop.yCoord - 1, crop.zCoord);
        int meta = crop.getWorldObj()
            .getBlockMetadata(crop.xCoord, crop.yCoord - 1, crop.zCoord);
