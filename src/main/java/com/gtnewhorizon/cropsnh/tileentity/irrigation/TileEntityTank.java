...
import com.gtnewhorizon.cropsnh.network.MessageSyncFluidLevel;
...
import com.gtnewhorizon.cropsnh.utility.multiblock.MultiBlockManager;
import com.gtnewhorizon.cropsnh.utility.multiblock.MultiBlockPartData;
...
public class TileEntityTank extends TileEntityCustomWood implements IFluidHandler, IIrrigationComponent, IMultiBlockComponent<MultiBlockManager, MultiBlockPartData>, IDebuggable {
    ...
    public void addWailaInformation(List information) {
        ...
        information.add(StatCollector.translateToLocal("cropsnh_tooltip.waterLevel") + ": " + this.getFluidLevel() + "/" + this.getCapacity());
    }
}
