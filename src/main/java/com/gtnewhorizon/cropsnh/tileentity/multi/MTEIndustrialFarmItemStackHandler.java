...
public class MTEIndustrialFarmItemStackHandler extends ItemStackHandler {
    ...
    public boolean isItemValid(int slot, ItemStack stack) {
        ...
        if (this.multiblock.mMaxProgresstime != 0 || multiblock.isAllowedToWork()
            || CropsNHUtils.isStackInvalid(stack)) {
            return false;
        }
        ...
        switch (slot) {
            ...
            default -> {
                ...
                if (slot < 0 || this.multiblock.environmentalEnhancementUnitCount <= slot) return false;
