...
public class CropLiveroot extends NHCropCard {
    ...
    public CropLiveroot() {
        ...
        this.addDrop(GTOreDictUnificator.get(OrePrefixes.dust, Materials.LiveRoot, 1), 75_00);
        this.addDrop(ItemList.TF_LiveRoot.get(1), 75_00);

        this.addDuplicationCatalyst(GTOreDictUnificator.get(OrePrefixes.dust, Materials.LiveRoot, 1));
