...
public interface IMultiBlockManager<T extends IMultiBlockPartData> {
     ...
     */
    void onBlockPlaced(World world, int x, int y, int z,
            IMultiBlockComponent<? extends IMultiBlockManager<T>, T> component);
     ...
     */
    void onBlockBroken(World world, int x, int y, int z,
            IMultiBlockComponent<? extends IMultiBlockManager<T>, T> component);
