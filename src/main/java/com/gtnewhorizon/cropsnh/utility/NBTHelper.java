    ...
    public static void sortStacks(NBTTagList list) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            for (int j = 0; j < list.tagCount(); j++) {
                ...
                String firstName = first.getDisplayName().equalsIgnoreCase("Seeds") ? "Wheat Seeds"
                        : first.getDisplayName();
                String stackAtIndexName = stackAtIndex.getDisplayName().equalsIgnoreCase("Seeds") ? "Wheat Seeds"
                        : stackAtIndex.getDisplayName();
