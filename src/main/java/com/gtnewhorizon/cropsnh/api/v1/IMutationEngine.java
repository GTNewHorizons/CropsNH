 ...
 * It contains a pointer to the relevant ICrop object, a Random object, the IMutationHandler instance and the
 * IStatCalculator object.
 */
public interface IMutationEngine {
    ...
    /**
     * This method returns the currently used IStatCalculator object by cropsnh,
     * it is recommended to use this to calculate the new seed stats after a mutation.
     * This can either be the default cropsnh stat logic, or stat logic registered via the API.
     * If you want to do your own stat logic as well, register a new IStatCalculator object via
     ...
     * If you want to have your own stat calculation logic without the possibility of others meddling with it, ignore
     * this and do stat calculation internally.
     *
