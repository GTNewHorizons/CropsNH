 ...
 * one instance. This instance can be retrieved via APIv3.getMutationHandler().
 *
 * IMPORTANT: The IMutationHandler instance is initialized in onServerAboutToStartEvent() on the server, and its data is
 * sent to clients connecting to it.
 */
public interface IMutationHandler {
     ...
     * to it. The argument may be empty but can not be null.
     * 
    ...
    /**
     * Creates a new IMutation instance which has the default CropsNH implementation. This is the recommended approach
     * to create new IMutation objects.
     * 
    ...
    /**
     * Sets the currently used IMutationLogic object to the argument. This will effectively change the behaviour of
     * CropsNH mutations to the logic within the passed object.
     * 
