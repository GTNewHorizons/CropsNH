...
public interface IMutation {
    ...
    /**
     * The chance a mutation will actually be applied if it has been triggered. When a cross crop receives a growth
     * tick, there is a percentage chance nothing will happen. Then there is a percentage chance weeds will spawn (if
     * enabled in the config) Then either a mutation happens or a spread happens based on the chance defined in the
     * config.
     *
