...
public interface IFertiliser {
    ...
    /**
     * return true here if you want a custom behaviour when this fertiliser is used on a crop, else it will just mimic
     * bonemeal behaviour
     */
    boolean hasSpecialBehaviour();

    /**
     * this is called when the fertiliser is used on a crop, this only is called if true is returned from
     * hasSpecialBehaviour
     */
