 ...
 * applied to the cross crop.
 * The crop will have a new plant with 0% growth and the seed's item and meta will be determined by the getSeed() and
 * getMeta() methods.
...
public interface ICrossOverResult {
     ...
     * In default CropsNH behaviour this depends on the tier of the resulting seed.
     *
