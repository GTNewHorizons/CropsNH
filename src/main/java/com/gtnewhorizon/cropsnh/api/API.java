...
/**
 * This is the main entry point for the CropsNH API.
 *
 ...
 * no idea how to use it without shipping the api in your jar, it might help. But in general, short version:
 * </p>
 *
 * <pre>
...
public class API {
    ...
    /**
     * Returns an API object. Call this with the version number of the API you compiled against. It will do its best to
     * return you a matching object.
     *
     * This will never return null, so it is important that you check the APIBase.getStatus() and APIBase.getVersion()
     * before typecasting the result to any specific interface.
     *
