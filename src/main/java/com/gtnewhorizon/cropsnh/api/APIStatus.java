...
public enum APIStatus {
	 ...
	 *
	 * - You called getAPI() before CropsNH was initialized. Don't call
	 * getAPI() in the PREINIT phase.
	 *
	 * - Someone included the API with their mod, CropsNH is not actually
	 * installed.
	 */
	API_NOT_INITIALIZED,
	/**
	 ...
	 * The API was properly loaded and your API object is ready to go.
	 *
	 * The CropsNH that returned your API object supports a newer version than
