...
public class ExampleCropsNHAPIimplementation extends ExampleCropsNHAPIwrapper {
    ...
    /**
     * Here are the actual implementations for the methods you need to call API methods Note the isOk() calls, this is
     * not necessary, but guarantees that your implementation will not start returning values you don't expect, for
     * instance when the api version you use becomes {@Link APIStatus.ERROR} or {@Link APIStatus.BACKLEVEL_UNSUPPORTED}
     */
