 ...
 * but I highly recommend it doing this way if you don't know how to use or reference the API without shipping it with
 * your mod.
...
public class ExampleCropsNHAPIwrapper {
     ...
     * If CropsNH is not present, it sets it to a placeholder (which is this class) which returns default values and
     * never references the CropsNH API.
     * If CropsNH is loaded, it sets it to an actual class forwarding the calls to the CropsNH API (see the
