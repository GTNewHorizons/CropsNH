...
public interface Handle {
     ...
     * Closes the handle.
     * <p/>
     * For example, if there is an underlying stream, this should close that stream. Any future calls to {@link #read}
     * or {@link #write} should throw an <tt>IOException</tt> after this function was called.
     */
    void close();
     ...
     * @throws IOException if the file was opened in writing mode or an I/O error occurred or the file was already
     *                     closed.
     */
     ...
     * @throws IOException if the file was opened in read-only mode, or another I/O error occurred (no more space, for
     *                     example), or the file was already closed.
     */
