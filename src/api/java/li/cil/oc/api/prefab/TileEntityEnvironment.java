...
/**
 * TileEntities can implement the {@link li.cil.oc.api.network.Environment} interface to allow them to interact with the
 * component network, by providing a {@link li.cil.oc.api.network.Node} and connecting it to said network.
 * <p/>
