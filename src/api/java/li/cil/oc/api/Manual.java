 ...
 * <p/>
 * It allows opening the manual at a desired specific page, as well as registering custom tabs and content callback
 * handlers.
 * <p/>
 * Note: this is a <em>client side only</em> API. It will do nothing on dedicated servers (i.e. <tt>API.manual</tt> will
 * be <tt>null</tt>).
 */
public class Manual {
     ...
     * returned renderer to draw an element in the place of the tag. The provided prefix is expected to be
     * <em>without</em> the colon (<tt>:</tt>).
     * <p/>
