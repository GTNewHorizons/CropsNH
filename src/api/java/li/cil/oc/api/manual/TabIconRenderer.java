 ...
 * <p/>
 * Each renderer instance represents the single graphic it is drawing. To provide different graphics for different tabs
 * you'll need to create multiple tab renderer instances.
 * <p/>
 *
...
public interface TabIconRenderer {
     ...
     * <p/>
     * This should render something in a 16x16 area. The OpenGL state has been adjusted so that drawing starts at
