 ...
 * <p/>
 * This is used for generating NEI usage pages with a button opening the manual on the page at the specified path, or
 * for opening the manual when held in hand and sneak-activating a block in the world.
 * <p/>
 * This way you can easily make entries in your documentation available the same way OpenComputers does it itself.
 * <p/>
 * Note that you can use the special variable <tt>%LANGUAGE%</tt> in your paths, for language agnostic paths. These will
 * be resolved to the currently set language, falling back to <tt>en_US</tt>, during actual content lookup.
 */
public interface PathProvider {
     ...
     * <p/>
     * Return <tt>null</tt> if there is no known page for this item, allowing other providers to be queried.
     *
