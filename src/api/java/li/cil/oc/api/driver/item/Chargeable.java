 ...
 * <p/>
 * This provides a generic way of charging items, even such that are not components. Doing it this way enables items to
 * provide another environment, that is unrelated to charging, such as tablets providing their file system, while in the
 * charger.
 */
public interface Chargeable {
     ...
     * <p/>
     * This is primarily meant to filter meta item subitems that are not meant to be chargeable.
     *
