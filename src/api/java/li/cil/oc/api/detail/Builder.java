...
public interface Builder<T extends Node> {
     ...
     * <p/>
     * This performs the actual creation of the node, initializes it to the settings defined by the current builder and
     * returns it.
     *
    ...
    interface NodeBuilder extends Builder<Node> {
         ...
         * <p/>
         * Nodes that are components can be accessed from computers, methods declared in them marked using the
         * {@link li.cil.oc.api.machine.Callback} annotation can be invoked from computers that can see the component.
         *
         ...
         * <p/>
         * A connector node can feed power into the network and extract power from the network. This is used both for
         * passive energy drain (such as running screens and computers) and for active power consumption (such as
         * wireless message sending or robot actions).
         *
    ...
    /**
     * Builder for component nodes. These node can be interacted with from computers in the same network, that can
     * <em>see</em> the component.
     */
    ...
    /**
     * Builder for connector nodes. These nodes can interact with the energy stored in the network, i.e. increase or
     * reduce it.
     */
