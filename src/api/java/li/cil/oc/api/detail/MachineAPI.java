...
public interface MachineAPI {
     ...
     * <p/>
     * Note that although registration is optional, it is strongly recommended to allow {@link #architectures()} to be
     * useful.
     *
     ...
     * {@link #create(li.cil.oc.api.machine.MachineHost)} with a not yet registered architecture. What this means is
     * that unless a mod providing a custom architecture also registers it, you may not see it in this list until it
     * also created a new machine using that architecture.
     */
