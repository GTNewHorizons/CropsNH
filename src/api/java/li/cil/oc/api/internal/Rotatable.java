...
/**
 * This interface is implemented by the computer case and robot tile entities to allow item components to query the
 * orientation of their host, i.e. to allow getting the facing of the tile entity passed to their drivers'
...
public interface Rotatable {
    ...
    /**
     * Converts a facing relative to the block's <em>local</em> coordinate system to a <tt>global orientation</tt>,
     * using south as the standard orientation.
     * <p/>
     * For example, if the block is facing east, calling this with south will return east, calling it with west will
     * return south and so on.
     *
    ...
    /**
     * Converts a <tt>global</tt> orientation to a facing relative to the block's <em>local</em> coordinate system,
     * using south as the standard orientation.
     * <p/>
     * For example, if the block is facing east, calling this with south will return east, calling it with west will
     * return north and so on.
     *
     * @param value the value to translate.
     * @return the translated orientation.
     */
