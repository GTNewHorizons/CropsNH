...
public interface Agent extends MachineHost, Rotatable {
     ...
     * <p/>
     * For example, for the robot this is the tool slot as well as slots provided by containers installed in the robot,
     * if any.
     * <p/>
     ...
     * <p/>
     * This will automatically be positioned and rotated to represent the agent's current position and rotation in the
     * world. Use this to trigger events involving the agent that require a player entity.
     * <p/>
