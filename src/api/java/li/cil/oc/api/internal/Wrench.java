...
public interface Wrench {
     ...
     * <p/>
     * This is called in two scenarios, once when testing whether the wrench can be used on a certain block, in which
     * case the <tt>simulate</tt> argument will be <tt>true</tt>, and once when actually used on a block, in which case
     * the <tt>simulate</tt> argument will be <tt>false</tt>, allowing the tool to damage itself, for example.
     * <p/>
