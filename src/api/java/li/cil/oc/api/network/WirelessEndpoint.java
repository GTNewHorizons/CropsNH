 ...
 * <p/>
 * These can be added to the wireless network via the <tt>Network</tt> API, to allow them to receive packets like
 * wireless network cards and access points do (and handle or forward them as they see fit).
 * <p/>
...
public interface WirelessEndpoint {
     ...
     * @param sender the endpoint that sent the message. This is not necessarily the original sender of the packet, just
     *               the last point it went through, such as an access point, for example.
     */
