...
public interface IRedNetConnection {
    ...
    /**
     * Returns the connection type of this Block. If this value must be changed while the block is alive, it must notify
     * neighbors of a change.
     * <p>
     * For nodes that want to interact with rednet, see IRedNetInputNode, IRedNetOutputNode, and IRedNetOmniNode
     *
