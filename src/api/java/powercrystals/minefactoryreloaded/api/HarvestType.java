...
public enum HarvestType {
    ...
    Tree,
    /**
     * This block is the base of the tree and the harvester should enter tree-cutting mode. The tree is searched for in
     * the negative y axis instead.
     */
    TreeFlipped,
    /**
    ...
    TreeLeaf,
    /**
     * This block is part of a tree as above, but fruits are cut before logs. e.g. cocoa The tree is not searched for.
     */
    TreeFruit
}
