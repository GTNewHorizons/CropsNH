 ...
 * signature:
 *
 * package aaa.bbb.ccc; public class HydraulicraftHandler{ public static void init(IHydraulicraftRegistrar registrar){
 *
 * } }
 *
...
public interface IHydraulicraftRegistrar {
     ...
     * {@link IHarvesterTrolley#getName()}. You can use this to register crafting recipes for example.
     * 
     * @param trolleyName
     * @return
     */
