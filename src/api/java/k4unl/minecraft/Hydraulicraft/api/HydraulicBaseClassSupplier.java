...
/**
 * 
 * @author minemaarten Original idea and class from PneumaticCraft. Modified by K-4U for Hydraulicraft. Deprecated in
 *         favour of HCApi
 */
@Deprecated
public class HydraulicBaseClassSupplier {
    ...
    public static IBaseClass getBaseClass(TileEntity target, int maxStorage) {
        ...
        try {
            if (baseHandlerConstructor == null) baseHandlerConstructor = Class
                    .forName("k4unl.minecraft.Hydraulicraft.tileEntities.TileHydraulicBase").getConstructor(int.class);
    ...
    public static IBaseClass getBaseClass(TMultiPart target, int maxStorage) {
        IBaseClass baseClassEntity = null;
        try {
            if (multipartConstructor == null) multipartConstructor = Class
                    .forName("k4unl.minecraft.Hydraulicraft.tileEntities.TileHydraulicBase").getConstructor(int.class);
