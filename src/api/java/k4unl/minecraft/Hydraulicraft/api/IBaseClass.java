...
public interface IBaseClass {
    ...
    /**
     * Use this to tell the base class to tell its target. Just use init(this);
     * 
     * @param target
     */
    ...
    /**
     * Takes the pressure to add and checks if there is oil in the system. Use this function to add pressure from a
     * generator
     * 
     * @param pressureToAdd
     */
