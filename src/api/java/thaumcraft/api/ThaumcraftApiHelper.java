...
public class ThaumcraftApiHelper {
    ...
    private static final HashMap<Integer, AspectList> allAspects = new HashMap<>();
    private static final HashMap<Integer, AspectList> allCompoundAspects = new HashMap<>();
    ...
    /**
     * Use to subtract vis from a wand for most operations Wands store vis differently so "real" vis costs need to be
     * multiplied by 100 before calling this method
     * 
     ...
     * @param crafting is this a crafting operation or not - if false then things like frugal and potency will apply to
     *                 the costs
    ...
    /**
     * Subtract vis for use by a crafting mechanic. Costs are calculated slightly differently and things like the frugal
     * enchant is ignored Must NOT be multiplied by 100 - send the actual vis cost
     * 
     * @param wand   the wand itemstack
     * @param player the player using the wand
     * @param cost   the cost of the operation.
    ...
    /**
     * Subtract vis from a wand the player is carrying. Works like consumeVisFromWand in that actual vis costs should be
     * multiplied by 100. The costs are handled like crafting however and things like frugal don't effect them
     * 
     * @param player the player using the wand
     * @param cost   the cost of the operation.
     * @return was the vis successfully subtracted
    ...
    /**
     * This "sticky" warp to a player. Sticky warp is permanent warp that can be removed. It will automatically be
     * synced clientside
     * 
     * @param player the player using the wand
