...
/**
 * @author Azanor This interface is used by tiles that use or transport vis. Only tiles that implement this interface
 *         will be able to connect to vis conduits or other thaumic devices
 */
