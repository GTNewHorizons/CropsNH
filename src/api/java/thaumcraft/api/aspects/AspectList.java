...
public class AspectList implements Serializable {
    ...
    /**
     * Reduces the amount of an aspect in this collection by the given amount. If reduced to 0 or less the aspect will
    ...
    /**
     * Adds this aspect and amount to the collection. If the aspect exists then its value will be increased by the given
     * amount.
     * 
     * @param aspect
     * @param amount
    ...
    /**
     * Adds this aspect and amount to the collection. If the aspect exists then only the highest of the old or new
     * amount will be used.
     * 
     * @param aspect
     * @param amount
