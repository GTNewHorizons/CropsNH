 ...
 * @author Azanor
 *
 *         This class is used to keep the material information for the various rods. It is also used to generate the
 *         wand recipes ingame.
 *
 */
public class WandRod {
    ...
    /**
     * The amount of vis that can be stored - this number is actually multiplied by 100 for use by the wands internals
     */
    int capacity;
