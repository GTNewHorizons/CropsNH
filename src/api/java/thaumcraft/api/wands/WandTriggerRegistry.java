...
/**
 * This class serves a similar function to IWandable in that it allows wands to interact with object in the world. In
 * this case it is most useful for adding interaction with non-mod blocks where you can't control what happens in their
 * code. Example where it is used is in crafting the thaumonomicon from a bookshelf and the crucible from a cauldron
 *
 * @author azanor
 *
 */
public class WandTriggerRegistry {
    ...
    /**
     * Registers an action to perform when a casting wand right clicks on a specific block. A manager class needs to be
     * created that implements IWandTriggerManager.
     * 
     * @param manager
    ...
    /**
     * This is called by the onItemUseFirst function in wands. Parameters and return value functions like you would
