...
public class VisNetHandler {
    ...
    // / NODE DRAINING
    /**
     * This method drains vis from a relay or source near the passed in location. The amount received can be less than
     * the amount requested so take that into account.
     *
     * @param world
