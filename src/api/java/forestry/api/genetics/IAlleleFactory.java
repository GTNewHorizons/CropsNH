...
public interface IAlleleFactory {
     ...
     * @param isDominant allele dominance
     * @return a new IAlleleBoolean Note that valueName will always be "true" or "false"
     */
     ...
     * @param isDominant allele dominance
     * @return a new IAlleleFlowers IAlleleFlowers localization is handled by the IFlowerProvider.getDescription(),
     *         unlike the other alleles.
     */
