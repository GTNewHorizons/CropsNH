...
/**
 * Internal interface for the Lexicon Entry GUI. This contains everything that can be accessed from it. It's safe to
 * cast this type to GuiScreen.
 */
public interface IGuiLexiconEntry {
    ...
    /**
     * Gets the total amount of ticks (+ partial ticks) the player has been in this gui.
     */
    ...
    /**
     * Gets the delta (1F = 1 tick) between this render call and the last one.
     */
    float getTickDelta();
}
