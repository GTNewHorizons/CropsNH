...
/**
 * Any methods that refer to internal methods in Botania are here. This is defaulted to a dummy handler, whose methods
 * do nothing. This handler is set to a proper one on PreInit. Make sure to make your mod load after Botania if you have
 * any intention of doing anythign with this on PreInit.
 */
public interface IInternalMethodHandler {
    ...
    @SideOnly(Side.CLIENT)
    void drawComplexManaHUD(int color, int mana, int maxMana, String name, ScaledResolution res, ItemStack bindDisplay,
            boolean properlyBound);
