...
/**
 * A TileEntity that implements this be called by other TileEntities to allow for it to do any request at any time. This
 * is used by the Corporea Retainer for example.
 */
