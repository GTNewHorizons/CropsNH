...
/**
 * A Sub-TileEntity, this is used for the flower system. Make sure to map subclasses of this using
 * BotaniaAPI.mapSubTile(String, Class). Any subclass of this must have a no parameter constructor.
 */
public class SubTileEntity {
    ...
    /**
     * Writes some extra data to a network packet. This data is read by readFromPacketNBT on the client that receives
     * the packet. Note: This method is also used to write to the world NBT.
     */
    public void writeToPacketNBT(NBTTagCompound cmp) {}

    /**
     * Reads data from a network packet. This data is written by writeToPacketNBT in the server. Note: This method is
     * also used to read from the world NBT.
     */
    ...
    /**
     * Called when a Wand of the Forest is used on this sub tile. Note that the player parameter can be null if this is
     * called from a dispenser.
     */
    ...
    /**
     * Gets the block coordinates this is bound to, for use with the wireframe render when the sub tile is being hovered
    ...
    /**
     * Returns a descriptor for the radius of this sub tile. This is called while a player is looking at the block with
     * a Manaseer Monocle (IBurstViewerBauble).
     */
    @SideOnly(Side.CLIENT)
    ...
    /**
     * Called on the client when the block being pointed at is the one with this sub tile. Used to render a HUD
     * portraying some data from this sub tile.
     */
    @SideOnly(Side.CLIENT)
