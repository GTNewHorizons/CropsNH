...
public abstract class SubTileSignature {
    ...
    /**
     * Gets the lore text for the flower item, displayed in the item's tooltip. If you do not want a reference return a
     * key that does not have localization such as "botaniamisc.noloc".
     */
