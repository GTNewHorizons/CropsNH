...
/**
 * An interface that defines an instance of PlayerControllerMP with the ability to modify reach. See
 * vazkii.botania.client.core.handler.BotaniaPlayerController
 */
