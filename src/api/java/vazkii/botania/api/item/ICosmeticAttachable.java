...
/**
 * An Item that implements this interface can have cosmetic items attached to it. The item does not have to be a bauble,
 * but it is the render is automatically handled by botania internally. Recipes to add and remove the cosmetic items
 * will be handled internally, but the cosmetic item has to be set as a container item.
 */
