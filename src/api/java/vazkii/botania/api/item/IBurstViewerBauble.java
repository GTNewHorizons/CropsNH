...
/**
 * Base Interface for the Manaseer Monocle and items of the sort. Having a IBauble of this type equipped on the 0th slot
 * (amulet) will draw bursts without depth testing and to see sub tile radiuses.
 */
