...
/**
 * An item that implements this will allow for various wireframes to be drawn around the player. This will be called
 * while the item is in the inventory, armor slot or bauble slots.
 */
public interface IWireframeCoordinateListProvider {

    /**
     * Returns a list of ChunkCoordinates for the wireframes to draw. Can be null.
     */
