...
/**
 * An item that implements this can break multiple blocks at once with a Ring of Loki. Usage of this interface requires
 * an implementation (see ItemTerraPick).
 */
public interface ISequentialBreaker {

    void breakOtherBlock(EntityPlayer player, ItemStack stack, int x, int y, int z, int originX, int originY,
