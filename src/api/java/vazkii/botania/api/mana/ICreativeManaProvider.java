...
/**
 * Have an item implement this to flag it as an infinite mana source for the purposes of the HUD rendered when an
 * IManaUserItem implementing item is present.
 */
