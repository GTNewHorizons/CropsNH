...
/**
 * A TileEntity that implements this will get it's recieveMana call called on both client and server. If this is not
 * implemented the call will only occur on the server.
 */
