...
public interface ILensEffect {
    ...
    /**
     * Called when a mana spreader that has this focus shoots a burst. This is where you change the properties of the
     * burst.
     */
    void apply(ItemStack stack, BurstProperties props);

    /**
     * Called when a mana burst fired from a mana spreader with this focus collides against any block. This is called
     * after the collision is handled.
     * 
     * @return True to kill the burst. False to keep it alive.
     */
    boolean collideBurst(IManaBurst burst, MovingObjectPosition pos, boolean isManaBlock, boolean dead,
            ItemStack stack);

    /**
     * Called when a mana burst fired from a mana spreader with this focus is updated. This is called before the update
     * is handled.
     */
