...
/**
 * A TileEntity that will only send a few packets rather than one per every entity collision. markDispatchable marks
 * that this TE needs to send a packet. Further handling is to be done in the TE itself.
 */
