...
/**
 * An item that implements this can be counted as an item that can contain mana.
 */
public interface IManaItem {
    ...
    /**
     * If this item simply does not export mana at all, set this to true. This is used to skip items that contain mana
     * but can't export it when drawing the mana bar above the XP bar.
     */
