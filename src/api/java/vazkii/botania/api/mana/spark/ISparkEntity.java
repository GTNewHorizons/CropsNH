...
public interface ISparkEntity {
     ...
     *
     * int x = MathHelper.floor_double(posX); int y = MathHelper.floor_double(posY) - 1; int z =
     * MathHelper.floor_double(posZ); TileEntity tile = worldObj.getTileEntity(x, y, z); if(tile != null && tile
     * instanceof ISparkAttachable) return (ISparkAttachable) tile;
     * 
     * return null;
     */
