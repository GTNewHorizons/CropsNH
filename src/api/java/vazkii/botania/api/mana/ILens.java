...
public interface ILens extends ILensEffect {
    ...
    /**
     * Can the source lens be combined with the composite lens? This is called for both the ILens instance of
     * ItemStack.getItem() of sourceLens and compositeLens.
     */
