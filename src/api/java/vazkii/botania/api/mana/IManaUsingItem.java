...
/**
 * Any item that implements this interface is an item that would use mana from the player's inventory. If there's any
 * items in the inventory or equipped in either the baubles or armor inventories that implement this interface, a mana
