...
/**
 * A Botania boss whose HP bar makes use of shaders. Shaders used through this have a few uniforms available:
...
public interface IBotaniaBossWithShader extends IBotaniaBoss {
    ...
    /**
     * The Shader Program to use for this boss bar. Return 0 case you don't want a shader to be used. You can use
     * separate shaders for the background and foreground.
     * 
     * @param background True if rendering the background of the boss bar, false if rendering the bar itself that shows
     *                   the HP.
     */
