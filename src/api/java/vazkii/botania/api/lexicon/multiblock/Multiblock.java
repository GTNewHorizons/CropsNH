...
/**
 * This class describes a Mutiblock object. It's used to display a multiblock in the lexicon and to show the player in a
 * ghost-like look in the world.
 */
public class Multiblock {
    ...
    /**
     * Adds a multiblock component to this multiblock. The component's x y z coords should be pivoted to the center of
     * the structure.
     */
    ...
    /**
     * Constructs and adds a multiblock component to this multiblock. The x y z coords should be pivoted to the center
     * of the structure.
     */
    ...
    /**
     * Rotates this multiblock by the angle passed in. For the best results, use only multiples of pi/2.
     */
    ...
    /**
     * Creates a length 4 array of all the rotations multiple of pi/2 required to render this multiblock in the world
     * relevant to the 4 cardinal orientations.
     */
