...
public abstract class LexiconPage {
    ...
    /**
     * Called per update tick. Feel free to override fully, the call to updateScreen() is for backwards compatibility.
     */
    @SideOnly(Side.CLIENT)
    ...
    /**
     * Called when this page is opened, be it via initGui() or when the player changes page. You can add buttons and
     * whatever you'd do on initGui() here.
     */
    @SideOnly(Side.CLIENT)
    ...
    /**
     * Called when this page is opened, be it via closing the gui or when the player changes page. Make sure to dispose
     * of anything you don't use any more, such as buttons in the gui's buttonList.
     */
    @SideOnly(Side.CLIENT)
    ...
    /**
     * Shows the list of recipes present in this page for display in the category page. Can return null for an entry
     * with no recipes.
     */
