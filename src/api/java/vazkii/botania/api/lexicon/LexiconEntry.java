...
public class LexiconEntry implements Comparable<LexiconEntry> {
    ...
    /**
     * Sets the display icon for this entry. Overriding the one already there. When adding recipe pages to the entry,
     * this will be called once for the result of the first found recipe.
     */
    ...
    /**
     * Returns the web link for this entry. If this isn't null, looking at this entry will show a "View Online" button
     * in the book. The String returned should be the URL to open when the button is clicked.
     */
