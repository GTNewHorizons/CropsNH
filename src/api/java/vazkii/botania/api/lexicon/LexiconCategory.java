...
public class LexiconCategory implements Comparable<LexiconCategory> {
    ...
    /**
     * Sets the priority for this category for sorting. Higher numbers means they'll appear first in the book. The
     * basics category is 9, the miscellaneous category is 0, other vanilla botania categories are 5. Using 9 and 0 is
     * <b>not</b> recommended, since having your categories before basics or after miscellaneous is a bad idea. If two
     * categories have the same priority they'll be sorted by insertion order.
     */
