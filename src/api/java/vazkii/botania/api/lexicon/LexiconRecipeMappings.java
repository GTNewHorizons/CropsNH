...
/**
 * This class contains mappings for which entry and page correspond to each craftable ItemStack. Use the map method to
 * map an ItemStack to a page in an entry in the lexicon.
 */
