...
/**
 * An Item that implements this is a Brew item, by which it contains a brew. This is only used in vanilla to prevent the
 * brew item from going back into the brewery but other mods might use it for whatever.
 */
