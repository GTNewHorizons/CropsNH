...
public class Brew {
     ...
     * @param color   The color for the potion to be rendered in the bottle, note that it will get changed a bit when it
     *                renders (for more or less brightness) to give a fancy effect.
    ...
    /**
     * Returns the key for this brew, for it to be found in the map in the API. This should ALWAYS return the same
     * result.
     */
    ...
    /**
     * Gets the display color for the ItemStack passed in. Note that for the lexicon, this passes in a botania Managlass
    ...
    /**
     * Gets the list of potion effects for the ItemStack passed in. Note that for the lexicon, this passes in a botania
     * Managlass Vial or an Alfglass Flask at all times.
     */
